...
int main(int argc, char *argv[])
{
    ...
    cprintf("CIDE / Programa para multiplicar un numero por 2");
 
    gotoxy(3,7);cprintf("Hummano digite un numero entero: ");scanf("%d",&n);
    gotoxy(3,9);cprintf("El doble de %d es %d",n,2*n);
    gotoxy(3,18);cprintf("CIDE - Humano Presione cualquier tecla para terminar...");
    getch();
    clrscr();
    return 0;
}
